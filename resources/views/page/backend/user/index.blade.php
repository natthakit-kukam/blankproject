                    ...
                    <div class="table-responsive scrollbar">
                        <table class="table table-striped overflow-hidden">
                            ...
                            <tbody>
                                            ...
                                            <button class="btn btn-link text-600 btn-sm dropdown-toggle btn-reveal"
                                                ...
                                                aria-haspopup="true" aria-expanded="false"><span
                                                 ...
                                                 <div class="dropdown-menu dropdown-menu-end border py-0">
                                                    <div class="py-2">
                                                        <a class="dropdown-item" href="#"><i class="far fa-eye"></i> รายละเอียด</a>
                                                        <a class="dropdown-item" href="#"> <i class="far fa-edit"></i> แก้ไข</a>
                                                    </div>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <tr class="btn-reveal-trigger">
                                    <td>003</td>
                                    <td><a href="#">หมู่บ้านหนองยาง</a></td>
                                    <td>
                                        22 หมู่ 7 ต.พอ อ.เมือง จ.ศรีสะเกษ
                                    </td>
                                    <td>นายกอไก่ ขอใข่</td>
                                ...
                                <tr class="btn-reveal-trigger">
                                    <td>001</td>
                                    <td><a href="#">นะหน้าทองวิลเลจ</a></td>
                                    <td>
                                        22 หมู่ 7 ต.พอ อ.เมือง จ.ศรีสะเกษ
                                    </td>
                                    <td>นายกอไก่ ขอใข่</td>
