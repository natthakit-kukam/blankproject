                ...
                <div class="col-xxl-6">
                    ...
                    <div class="card card-xxl-stretch">
                        ...
                        <div class="card-header border-0 pt-5 pb-3">
                            <!--begin::Card title-->
                            <h3 class="card-title fw-bolder text-gray-800 fs-2">หน้าหลัก</h3>
                            <!--end::Card title-->
                            <!--begin::Card toolbar-->
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-50px me-2">
                                                        <span class="symbol-label">
                                                            <img alt="" class="w-25px" src="/frontend/assets/media/svg/brand-logos/aven.svg" />
                                                        </span>
                                                    </div>
                                                    <!--end::Logo-->
                                                    <div class="ps-3">
                                        ...
                                        <tr>
                                            ...
                                            <td class="p-0">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-50px me-2">
                                                        <span class="symbol-label">
                                                            <img alt="" class="w-25px" src="/frontend/assets/media/svg/brand-logos/leaf.svg" />
                                                        </span>
                                                    </div>
                                                    <!--end::Logo-->
                                                    <div class="ps-3">
                                        ...
                                        <tr>
                                            ...
                                            <td class="p-0">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-50px me-2">
                                                        <span class="symbol-label">
                                                            <img alt="" class="w-25px" src="/frontend/assets/media/svg/brand-logos/atica.svg" />
                                                        </span>
                                                    </div>
                                                    <!--end::Logo-->
                                                    <div class="ps-3">
                                        ...
                                        <tr>
                                            ...
                                            <td class="p-0">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-50px me-2">
                                                        <span class="symbol-label">
                                                            <img alt="" class="w-25px" src="/frontend/assets/media/svg/brand-logos/volicity-9.svg" />
                                                        </span>
                                                    </div>
                                                    <!--end::Logo-->
                                                    <div class="ps-3">
                                        ...
                                        <tr>
                                            ...
                                            <td class="p-0">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="symbol symbol-50px me-2">
                                                        <span class="symbol-label">
                                                            <img alt="" class="w-25px" src="/frontend/assets/media/svg/brand-logos/bebo.svg" />
                                                        </span>
                                                    </div>
                                                    <!--end::Logo-->
                                                    <div class="ps-3">
                        ...
                        <div class="col-xxl-6">
                            ...
                            <div class="card card-xxl-stretch-50" style="background-color: #1C53E1">
                                ...
                                <div class="card-body d-flex align-items-end p-0 pt-10">
                                    ...
                                    <!--end::Wrapper-->
                                    <img class="mh-200px" alt="" src="/frontend/assets/media/svg/illustrations/engage.svg" />
                                </div>
                                <!--end::Card body-->
                            </div>
                            <!--end::Engage widget 1-->
